...
module "monitor_shared_sg" {
  ...
  ingress_with_source_security_group_id = [

    {
      ...
      to_port                  = 18000
      protocol                 = "tcp"
      source_security_group_id = module.internal_elb_shared_sg.security_group_id
      description              = "allow internal-elb traffic to monitor"
    ...
    
    {
      ...
      to_port                  = 5100
      protocol                 = "tcp"
      source_security_group_id = module.ops_shared_sg.security_group_id
      description              = "allow ops traffic to monitor"
